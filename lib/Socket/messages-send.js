...
const makeMessagesSocket = (config) => {
    const { logger, linkPreviewImageThumbnailWidth, generateHighQualityLinkPreview, options: axiosOptions, blacklistLinkPreview, patchMessageBeforeSending, cachedGroupMetadata, } = config;
    ...
    const userDevicesCache = config.userDevicesCache || new node_cache_1.default({
        stdTTL: Defaults_1.DEFAULT_CACHE_TTLS.USER_DEVICES, // 30 minutes
        useClones: false
    });
    let mediaConn;
